  ...
  return (
    <div className="bg-white w-full h-[410px] shadow-lg rounded-xl overflow-hidden max-w-sm ">
      <img
        src={image}
        alt="Card Image"
        className="w-full h-52 object-cover p-4 overflow-hidden rounded-xl"
      />
      <div className="ml-4">
        ...
        <div className="flex items-center space-x-3 ">
          <img
            src={profile}
            alt="Profile"
            className="w-12 h-12 rounded-full border-2 border-emerald-500 mt-2"
          />
    ...
    <div className="bg-white w-[300px] rounded-2xl shadow-lg p-4 m-auto">
      ...
      <div className="p-4">
        <div className="flex items-center justify-between text-gray-600 text-sm mb-2">
          <span className="bg-emerald-100 text-emerald-500 px-2 py-1 rounded-md">
            {category}
          </span>
          <span>{duration}</span>
        </div>
    ...
    <>
      ...
      <section className="relative bg-sky-100 flex">
        ...
        <div className=" justify-around items-center m-auto bg-blue-100 ">
          <img
            className="w-[550px] m-auto mr-24"
            src="../src/assets/Rectangle32.png"
            alt=""
          />
        </div>
      </section>
